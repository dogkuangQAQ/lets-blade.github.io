      ...
      <footer className="footerSection nav-footer" id="footer">
        <section className="sitemap">
          ...
          <div>
            ...
            <object
              type="image/svg+xml"
              data="https://img.shields.io/twitter/follow/biezhii.svg?label=Follow+Blade&style=social"
            >
              <a href="https://twitter.com/intent/follow?screen_name=biezhii">
                <img
                  alt="Follow Prettier on Twitter"
                  src="https://img.shields.io/twitter/follow/biezhii.png?label=Follow+Blade&style=social"
                />
              </a>
            </object>
          </div>
