    ...
    <div className="homeContainer">
      <div className="homeSplashFade">
        <div className="wrapper homeWrapper">
          <div className="inner">
            <img src={siteConfig.baseUrl + siteConfig.mainImg} width="40%"/>
...
const EditorSupportSection = () => (
  <div className="editorSupportSection productShowcaseSection lightBackground">
    ...
    <div style={{ float: "right" }}>
      <span>Got more? </span>
      <a href={`${siteConfig.githubUrl}/pulls`} className="button"> Send a PR </a>
    </div>
  </div>
);
...
class GetStartedSection extends React.Component {
  ...
  render() {
        ...
        <Container>
          ...
          >
            <div className="getStartedSteps">
              ...
              <ol>
                <li>
                  Add blade to your project:
                  <div className="mavenOnly">
                    <MarkdownBlock>
                      {xml`<dependency>
    ...
    <version>LEAST_VERSION</version>
                  ...
                  <div className="gradleOnly">
                    <MarkdownBlock>
                    {bash`compile 'com.bladejava:blade-mvc:2.0.8-ALPHA2'`}
                    </MarkdownBlock>
                  </div>
                </li>
                <li>
...
public class Application {
    public static void main(String[] args) {
        Blade.me().start(Application.class, args);
            ...
            >
              <ButtonGroup>
                <a className="button active showMavenButton" href="javascript:void(0)">
                  maven
                </a>
                <a className="button showGradleButton" href="javascript:void(0)">
                  gradle
                </a>
              </ButtonGroup>
              <img
